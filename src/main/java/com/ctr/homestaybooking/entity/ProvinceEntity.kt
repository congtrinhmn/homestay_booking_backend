...
data class ProvinceEntity(
        ...
        var districtEntities: List<DistrictEntity>
) {
    fun toProvinceDto() = ProvinceDto(id, type, name)

    fun toProvinceDetailDto() = ProvinceDetailDto(id, type, name, districtEntities.map { it.toDistrictDto() })
}
